  ...
  <div class="flex h-screen bg-gray-50 font-sans">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
      ...
      <div v-if="userRole === 'Patient'" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 border-l-4 border-l-blue-500 flex items-center justify-between"
        >
          <div>
        ...
        <div
          class="bg-gradient-to-r from-blue-500 to-blue-600 p-6 rounded-2xl shadow-md text-white flex items-center justify-between cursor-pointer hover:shadow-lg transition-shadow"
      ...
      <div
        v-else-if="userRole === 'Admin' || userRole === 'Receptionist'"
      ...
      <div class="mt-8 bg-white p-8 rounded-2xl shadow-sm border border-gray-100 min-h-[400px]">
        ...
        <p class="text-gray-500 italic">
          Dữ liệu từ API sẽ được hiển thị ở đây trong các bước tiếp theo...
        </p>
      </div>
    </main>
  </div>
